const M = globalThis, j = M.ShadowRoot && (M.ShadyCSS === void 0 || M.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, D = /* @__PURE__ */ Symbol(), V = /* @__PURE__ */ new WeakMap();
let et = class {
  constructor(t, e, s) {
...
const z = globalThis, K = (r) => r, T = z.trustedTypes, F = T ? T.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, st = "$lit$", f = `lit$${Math.random().toFixed(9).slice(2)}$`, it = "?" + f, yt = `<${it}>`, A = document, S = () => A.createComment(""), C = (r) => r === null || typeof r != "object" && typeof r != "function", I = Array.isArray, mt = (r) => I(r) || typeof r?.[Symbol.iterator] == "function", k = `[ 	
    ...
    for (; (i = g.nextNode()) !== null && h.length < a; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const l of i.getAttributeNames()) if (l.endsWith(st)) {
          ...
          h.push({ type: 1, index: o, name: O[2], strings: $, ctor: O[1] === "." ? St : O[1] === "?" ? Ct : O[1] === "@" ? Pt : R }), i.removeAttribute(l);
        } else l.startsWith(f) && (h.push({ type: 6, index: o }), i.removeAttribute(l));
        if (rt.test(i.tagName)) {
          const l = i.textContent.split(f), u = l.length - 1;
          if (u > 0) {
            i.textContent = T ? T.emptyScript : "";
            for (let $ = 0; $ < u; $++) i.append(l[$], S()), g.nextNode(), h.push({ type: 2, index: ++o });
            i.append(l[u], S());
          }
        }
...
class U {
  ...
  k(t) {
    ...
    const e = this._$AH;
    let s, i = 0;
    for (const o of t) i === e.length ? e.push(s = new U(this.O(S()), this.O(S()), this, this.options)) : s = e[i], s._$AI(o), i++;
...
const Ot = (r, t, e) => {
  ...
  if (i === void 0) {
    ...
    s._$litPart$ = i = new U(t.insertBefore(S(), o), o, void 0, e ?? {});
  }
  return i._$AI(r), i;
};
const B = globalThis;
...
const Ht = { attribute: !0, type: String, converter: H, reflect: !1, hasChanged: L }, Tt = (r = Ht, t, e) => {
...
customElements.define("awc-button", x);
